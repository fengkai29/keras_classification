...
from keras.layers import Input,Dense,Conv2D,MaxPooling2D,AveragePooling2D,ZeroPadding2D,Flatten,Activation,add,BatchNormalization,GlobalAveragePooling2D,GlobalMaxPooling2D
...
def ResNet152(include_top=True, weights='imagenet',
              input_tensor=None, input_shape=None, pooling=None, classes=2):
    ...
    if weights == 'imagenet' and include_top and classes != 2:
